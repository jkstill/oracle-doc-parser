...
Previous Next JavaScript must be enabled to correctly display this content This includes information about shared server activity, the servers, common queues, and dispatcher queues. This view obtains information from V$SHARED_SERVER , V$DISPATCHER , V$CIRCUIT , and V$QUEUE , and is aggregated over all servers, dispatchers, queues, and circuits. See Also: " V$SHARED_SERVER " " V$DISPATCHER " " V$CIRCUIT " " V$QUEUE " See Also: " V$SHARED_SERVER " " V$DISPATCHER " " V$CIRCUIT " " V$QUEUE "