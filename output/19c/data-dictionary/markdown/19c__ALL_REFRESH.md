...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_REFRESH describes all refresh groups in the database. USER_REFRESH describes all refresh groups owned by the current user. See Also: " DBA_REFRESH " " USER_REFRESH " See Also: " DBA_REFRESH " " USER_REFRESH "