...
Previous Next JavaScript must be enabled to correctly display this content If this view is queried from the database instance, only the rows for that instance are shown. See Also: Oracle Automatic Storage Management Administrator's Guide for additional information about using views to display Oracle ASM information See Also: Oracle Automatic Storage Management Administrator's Guide for additional information about using views to display Oracle ASM information