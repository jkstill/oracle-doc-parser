...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_TAB_COMMENTS displays comments on all tables and views in the database. USER_TAB_COMMENTS displays comments on the tables and views owned by the current user. This view does not display the OWNER column. See Also: " DBA_TAB_COMMENTS " " USER_TAB_COMMENTS " See Also: " DBA_TAB_COMMENTS " " USER_TAB_COMMENTS "