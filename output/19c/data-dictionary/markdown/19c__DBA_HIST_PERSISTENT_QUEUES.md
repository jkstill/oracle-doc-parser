...
Previous Next JavaScript must be enabled to correctly display this content This view contains snapshots of V$PERSISTENT_QUEUES . See Also: " V$PERSISTENT_QUEUES " See Also: " V$PERSISTENT_QUEUES "