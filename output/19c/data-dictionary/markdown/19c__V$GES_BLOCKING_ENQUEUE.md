...
Previous Next JavaScript must be enabled to correctly display this content The output of this view is a subset of the output from V$GES_ENQUEUE . This is an Oracle Real Application Clusters view. See Also: " V$GES_ENQUEUE " for a description of all locks known to the lock manager See Also: " V$GES_ENQUEUE " for a description of all locks known to the lock manager