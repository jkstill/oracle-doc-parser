...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_XML_TABLES describes all XML tables in the database. USER_XML_TABLES describes the XML tables owned by the current user. This view does not display the OWNER column. See Also: " DBA_XML_TABLES " " USER_XML_TABLES " See Also: " DBA_XML_TABLES " " USER_XML_TABLES "