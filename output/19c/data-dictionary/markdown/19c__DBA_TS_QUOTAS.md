...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_TS_QUOTAS describes tablespace quotas for the current user. This view does not display the USERNAME column. See Also: " USER_TS_QUOTAS " See Also: " USER_TS_QUOTAS "