...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_CUBES describes all OLAP cubes in the database. USER_CUBES describes the OLAP cubes owned by the current user. This view does not display the OWNER column. See Also: " DBA_CUBES " " USER_CUBES " See Also: " DBA_CUBES " " USER_CUBES "