...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_DBFS_HS_COMMANDS shows all the registered store commands for all DBFS hierarchical stores owned by current user. This view does not display the STOREOWNER column. See Also: " USER_DBFS_HS_COMMANDS " See Also: " USER_DBFS_HS_COMMANDS "