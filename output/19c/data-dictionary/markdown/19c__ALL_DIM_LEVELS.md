...
Previous Next JavaScript must be enabled to correctly display this content DBA_DIM_LEVELS describes all dimension levels in the database. USER_DIM_LEVELS describes the levels of all dimensions owned by the current user. See Also: " DBA_DIM_LEVELS " " USER_DIM_LEVELS " See Also: " DBA_DIM_LEVELS " " USER_DIM_LEVELS "