...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_SCHEDULER_FILE_WATCHERS displays information about all Scheduler file watch requests in the database. USER_SCHEDULER_FILE_WATCHERS displays information about the Scheduler file watch requests owned by the current user. This view does not display the OWNER column. See Also: " DBA_SCHEDULER_FILE_WATCHERS " " USER_SCHEDULER_FILE_WATCHERS " See Also: " DBA_SCHEDULER_FILE_WATCHERS " " USER_SCHEDULER_FILE_WATCHERS "