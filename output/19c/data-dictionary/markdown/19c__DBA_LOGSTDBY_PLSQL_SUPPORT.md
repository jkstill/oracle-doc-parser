...
Previous Next JavaScript must be enabled to correctly display this content Note: In a CDB, this view shows data when queried in the root or a PDB. See Also: Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_ROLLING package Note: In a CDB, this view shows data when queried in the root or a PDB. See Also: Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_ROLLING package