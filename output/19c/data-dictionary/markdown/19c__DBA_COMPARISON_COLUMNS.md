...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_COMPARISON_COLUMNS displays information about the columns for the comparison objects owned by the current user. This view does not display the OWNER column. See Also: " USER_COMPARISON_COLUMNS " See Also: " USER_COMPARISON_COLUMNS "