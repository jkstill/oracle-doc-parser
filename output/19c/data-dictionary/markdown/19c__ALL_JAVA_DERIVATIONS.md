...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_JAVA_DERIVATIONS displays mapping information about Java source objects and their derived Java class objects and Java resource objects for all Java classes in the database. USER_JAVA_DERIVATIONS displays mapping information about Java source objects and their derived Java class objects and Java resource objects for the Java classes owned by the current user. This view does not display the OWNER column. See Also: " DBA_JAVA_DERIVATIONS " " USER_JAVA_DERIVATIONS " See Also: " DBA_JAVA_DERIVATIONS " " USER_JAVA_DERIVATIONS "