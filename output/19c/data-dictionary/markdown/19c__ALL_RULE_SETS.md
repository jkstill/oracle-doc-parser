...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_RULE_SETS describes all rule sets in the database. USER_RULE_SETS describes the rule sets owned by the current user. This view does not display the RULE_SET_OWNER column. See Also: " DBA_RULE_SETS " " USER_RULE_SETS " See Also: " DBA_RULE_SETS " " USER_RULE_SETS "