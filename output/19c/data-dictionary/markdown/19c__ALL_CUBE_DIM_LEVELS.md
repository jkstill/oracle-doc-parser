...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_CUBE_DIM_LEVELS describes all OLAP dimension levels in the database. USER_CUBE_DIM_LEVELS describes the OLAP dimension levels owned by the current user. This view does not display the OWNER column. See Also: " DBA_CUBE_DIM_LEVELS " " USER_CUBE_DIM_LEVELS " See Also: " DBA_CUBE_DIM_LEVELS " " USER_CUBE_DIM_LEVELS "