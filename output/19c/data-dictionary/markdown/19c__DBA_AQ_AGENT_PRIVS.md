...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_AQ_AGENT_PRIVS displays information about the registered AQ agents that are mapped to the current user. This view does not display the DB_USERNAME column. See Also: " USER_AQ_AGENT_PRIVS " See Also: " USER_AQ_AGENT_PRIVS "