...
| USER_GENERATED | VARCHAR2(3) | Indicates whether the column is a user-generated column ( YES ) or a system-generated column ( NO ) |
...
Previous Next JavaScript must be enabled to correctly display this content Its columns (except for SENSITIVE_COLUMN ) are the same as those in ALL_TAB_COLS . To gather statistics for this view, use the DBMS_STATS package. This view differs from DBA_TAB_COLUMNS in that system-generated hidden columns are not filtered out. Columns marked with an asterisk (*) in the table below remain for backward compatibility with Oracle7. This information is now in the [TAB|PART]_COL_STATISTICS views. See Also: " ALL_TAB_COLS " " DBA_TAB_COLUMNS " Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_STATS package See Also: " ALL_TAB_COLS " " DBA_TAB_COLUMNS " Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_STATS package