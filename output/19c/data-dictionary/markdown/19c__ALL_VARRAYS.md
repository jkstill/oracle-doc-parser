...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_VARRAYS describes all varrays in the database. USER_VARRAYS describes the varrays owned by the current user. This view does not display the OWNER column. See Also: " DBA_VARRAYS " " USER_VARRAYS " See Also: " DBA_VARRAYS " " USER_VARRAYS "