...
Previous Next JavaScript must be enabled to correctly display this content An operation can be a grow or a shrink of a dynamic memory component. All sizes are expressed in bytes.