...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_ADVISOR_SQLW_JOURNAL displays the journal entries for the workload objects owned by the current user. This view does not display the OWNER column. See Also: " USER_ADVISOR_SQLW_JOURNAL " See Also: " USER_ADVISOR_SQLW_JOURNAL "