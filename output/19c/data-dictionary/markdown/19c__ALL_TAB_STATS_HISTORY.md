...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_TAB_STATS_HISTORY provides a history of table statistics modifications for all tables in the database. USER_TAB_STATS_HISTORY provides a history of table statistics modifications for all tables owned by the current user. See Also: " DBA_TAB_STATS_HISTORY " " USER_TAB_STATS_HISTORY " See Also: " DBA_TAB_STATS_HISTORY " " USER_TAB_STATS_HISTORY "