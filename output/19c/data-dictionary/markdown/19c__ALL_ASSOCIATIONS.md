...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_ASSOCIATIONS describes all user-defined statistics in the database. USER_ASSOCIATIONS describes user-defined statistics associated with objects owned by the current user. See Also: " DBA_ASSOCIATIONS " " USER_ASSOCIATIONS " See Also: " DBA_ASSOCIATIONS " " USER_ASSOCIATIONS "