...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_VIEWS describes all views in the database. USER_VIEWS describes the views owned by the current user. This view does not display the OWNER column. See Also: " DBA_VIEWS " " USER_VIEWS " See Also: " DBA_VIEWS " " USER_VIEWS "