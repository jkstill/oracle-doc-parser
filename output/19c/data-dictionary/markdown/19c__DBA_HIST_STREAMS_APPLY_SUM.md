...
Previous Next JavaScript must be enabled to correctly display this content This view contains a snapshot of V$STREAMS_APPLY_COORDINATOR , V$STREAMS_APPLY_READER , and V$STREAMS_APPLY_SERVER . This view is intended for use with Automatic Workload Repository (AWR). See Also: " V$STREAMS_APPLY_COORDINATOR " " V$STREAMS_APPLY_READER " " V$STREAMS_APPLY_SERVER " See Also: " V$STREAMS_APPLY_COORDINATOR " " V$STREAMS_APPLY_READER " " V$STREAMS_APPLY_SERVER "