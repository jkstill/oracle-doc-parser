...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_MINING_MODEL_XFORMS describes the user-specified transformations embedded in all models accessible in the system. USER_MINING_MODEL_XFORMS describes the user-specified transformations embedded with the user's own models. This view does not display the OWNER column.