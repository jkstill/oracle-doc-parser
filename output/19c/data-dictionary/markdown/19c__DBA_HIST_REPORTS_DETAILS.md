...
Previous Next JavaScript must be enabled to correctly display this content Metadata for each report appears in the DBA_HIST_REPORTS view while the actual report is available in the DBA_HIST_REPORTS_DETAILS view. See Also: " DBA_HIST_REPORTS " See Also: " DBA_HIST_REPORTS "