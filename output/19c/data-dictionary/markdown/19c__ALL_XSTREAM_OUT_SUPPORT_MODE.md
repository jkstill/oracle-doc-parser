...
Previous Next JavaScript must be enabled to correctly display this content Related View DBA_XSTREAM_OUT_SUPPORT_MODE displays information about the level of XStream capture process support for the tables in the database. See Also: " DBA_XSTREAM_OUT_SUPPORT_MODE " See Also: " DBA_XSTREAM_OUT_SUPPORT_MODE "