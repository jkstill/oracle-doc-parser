---
id: 19c__ALL_ANALYTIC_VIEW_HIER_CLASS
name: ALL_ANALYTIC_VIEW_HIER_CLASS
object_type: data_dictionary_view
oracle_version: 19c
doc_type: database_reference
category: objects
tags: [all]
source_file: ALL_ANALYTIC_VIEW_HIER_CLASS.html
---
...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_ANALYTIC_VIEW_HIER_CLASS describes the classifications of the hierarchies in all analytic views in the database. USER_ANALYTIC_VIEW_HIER_CLASS describes the classifications of the hierarchies in the analytic views owned by the current user. This view does not display the OWNER column. See Also: " DBA_ANALYTIC_VIEW_HIER_CLASS " " USER_ANALYTIC_VIEW_HIER_CLASS " See Also: " DBA_ANALYTIC_VIEW_HIER_CLASS " " USER_ANALYTIC_VIEW_HIER_CLASS "