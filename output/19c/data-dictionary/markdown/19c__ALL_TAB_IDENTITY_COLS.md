...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_TAB_IDENTITY_COLS describes all table identity columns. USER_TAB_IDENTITY_COLS describes all table identity columns. This view does not display the OWNER column. See Also: " DBA_TAB_IDENTITY_COLS " " USER_TAB_IDENTITY_COLS " See Also: The ALTER TABLE statement in Oracle Database SQL Language Reference for more information about creating an identity column The CREATE TABLE statements in Oracle Database SQL Language Reference for more information about creating an identity column See Also: " DBA_TAB_IDENTITY_COLS " " USER_TAB_IDENTITY_COLS "