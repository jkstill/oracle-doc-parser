---
id: 19c__DBA_XSTREAM_SPLIT_MERGE
name: DBA_XSTREAM_SPLIT_MERGE
object_type: data_dictionary_view
oracle_version: 19c
doc_type: database_reference
category: general
tags: [dba]
source_file: DBA_XSTREAM_SPLIT_MERGE.html
---

# DBA_XSTREAM_SPLIT_MERGE

DBA_XSTREAM_SPLIT_MERGE displays information about XStream current automatic split and merge operations.
...
| JOB_STATE | VARCHAR2(15) | Current state of the job: DISABLED RETRY SCHEDULED SCHEDULED RUNNING COMPLETED BROKEN FAILED REMOTE SUCCEEDED CHAIN_STALLED |
| JOB_NEXT_RUN_DATE | VARCHAR2(64) | Next time the job will run |
