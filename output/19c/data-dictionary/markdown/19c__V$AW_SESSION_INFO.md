...
Previous Next JavaScript must be enabled to correctly display this content A transaction is a single exchange between a client session and Oracle OLAP. Multiple commands can execute within a single transaction.