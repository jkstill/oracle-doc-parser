...
source_file: V-GES_ENQUEUE.html
---
...
Previous Next JavaScript must be enabled to correctly display this content See Also: " V$GES_BLOCKING_ENQUEUE " for a description of all such locks that are currently blocking or being blocked See Also: " V$GES_BLOCKING_ENQUEUE " for a description of all such locks that are currently blocking or being blocked