...
Previous Next JavaScript must be enabled to correctly display this content Related View DBA_APPLY displays information about all apply processes in the database. See Also: " DBA_APPLY " Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_APPLY_ADM.STOP_APPLY procedure Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_XSTREAM_ADM.ENABLE_GG_XSTREAM_FOR_STREAMS procedure See Also: " DBA_APPLY " Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_APPLY_ADM.STOP_APPLY procedure Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_XSTREAM_ADM.ENABLE_GG_XSTREAM_FOR_STREAMS procedure