...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_CUBE_DIMENSIONS describes all OLAP cube dimensions in the database. USER_CUBE_DIMENSIONS describes the OLAP cube dimensions owned by the current user. This view does not display the OWNER column. See Also: " DBA_CUBE_DIMENSIONS " " USER_CUBE_DIMENSIONS " See Also: " DBA_CUBE_DIMENSIONS " " USER_CUBE_DIMENSIONS "