...
Previous Next JavaScript must be enabled to correctly display this content This view contains snapshots of V$INSTANCE_RECOVERY . See Also: " V$INSTANCE_RECOVERY " See Also: " V$INSTANCE_RECOVERY "