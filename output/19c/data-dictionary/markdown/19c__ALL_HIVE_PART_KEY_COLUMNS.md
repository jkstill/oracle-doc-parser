...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_HIVE_PART_KEY_COLUMNS provides information about all Hive table partition columns in the database. USER_HIVE_PART_KEY_COLUMNS provides information about all Hive table partition columns owned by the current user in the database. See Also: " DBA_HIVE_PART_KEY_COLUMNS " " USER_HIVE_PART_KEY_COLUMNS " See Also: " DBA_HIVE_PART_KEY_COLUMNS " " USER_HIVE_PART_KEY_COLUMNS "