...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_PLSQL_TYPES describes all the PL/SQL types in the database. USER_PLSQL_TYPES describes the user's own PL/SQL types. This view does not display the OWNER column. See Also: " DBA_PLSQL_TYPES " " USER_PLSQL_TYPES " See Also: " DBA_PLSQL_TYPES " " USER_PLSQL_TYPES "