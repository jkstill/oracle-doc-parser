...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_COLL_TYPES describes all named collection types in the database. USER_COLL_TYPES describes all named collection types owned by the current user. This view does not display the OWNER column. See Also: " DBA_COLL_TYPES " " USER_COLL_TYPES " See Also: " DBA_COLL_TYPES " " USER_COLL_TYPES "