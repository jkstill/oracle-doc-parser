---
id: 19c__ALL_ATTRIBUTE_DIM_ATTR_CLASS
name: ALL_ATTRIBUTE_DIM_ATTR_CLASS
object_type: data_dictionary_view
oracle_version: 19c
doc_type: database_reference
category: general
tags: [all]
source_file: ALL_ATTRIBUTE_DIM_ATTR_CLASS.html
---

# ALL_ATTRIBUTE_DIM_ATTR_CLASS

ALL_ATTRIBUTE_DIM_ATTR_CLASS describes the attribute classifications of the attribute dimensions accessible to the current user.
...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_ATTRIBUTE_DIM_ATTR_CLASS describes the attribute classifications of all attribute dimensions in the database. USER_ATTRIBUTE_DIM_ATTR_CLASS describes the attribute classifications of the attribute dimensions owned by the current user. This view does not display the OWNER column. See Also: " DBA_ATTRIBUTE_DIM_ATTR_CLASS " " USER_ATTRIBUTE_DIM_ATTR_CLASS " See Also: " DBA_ATTRIBUTE_DIM_ATTR_CLASS " " USER_ATTRIBUTE_DIM_ATTR_CLASS "