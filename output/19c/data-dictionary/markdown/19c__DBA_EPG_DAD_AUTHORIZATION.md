...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_EPG_DAD_AUTHORIZATION describes the DADs that are authorized to use the user's privileges. This view does not display the USERNAME column. See Also: " USER_EPG_DAD_AUTHORIZATION " See Also: " USER_EPG_DAD_AUTHORIZATION "