...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_JAVA_RESOLVERS displays information about resolvers of all Java classes in the database. USER_JAVA_RESOLVERS displays information about resolvers of the Java classes owned by the current user. This view does not display the OWNER column. See Also: " DBA_JAVA_RESOLVERS " " USER_JAVA_RESOLVERS " See Also: " DBA_JAVA_RESOLVERS " " USER_JAVA_RESOLVERS "