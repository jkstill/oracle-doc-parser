...
Previous Next JavaScript must be enabled to correctly display this content The following table describes what the ENTITY_ID and ENTITY_SEQUENCE are for each metric group: