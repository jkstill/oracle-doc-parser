---
id: 19c__V$ASM_ACFS_SEC_REALM_USER
name: V$ASM_ACFS_SEC_REALM_USER
object_type: data_dictionary_view
oracle_version: 19c
doc_type: database_reference
category: security
tags: [dynamic_performance]
source_file: V-ASM_ACFS_SEC_REALM_USER.html
---

# V$ASM_ACFS_SEC_REALM_USER

V$ASM_ACFS_SEC_REALM_USER contains an entry for every user in the Oracle ACFS security realm for each Oracle ACFS file system. This view also supports GV$ global views.
