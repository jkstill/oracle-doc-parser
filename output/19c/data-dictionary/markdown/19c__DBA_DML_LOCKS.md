...
Previous Next JavaScript must be enabled to correctly display this content See Also: Oracle Database Concepts for more information about lock modes for table locks See Also: Oracle Database Concepts for more information about lock modes for table locks