...
Previous Next JavaScript must be enabled to correctly display this content V$ENQUEUE_STATISTICS encompasses V$ENQUEUE_STAT and gives more detailed information (several rows for same enqueues with different reasons). See Also: " V$ENQUEUE_STAT " See Also: " V$ENQUEUE_STAT "