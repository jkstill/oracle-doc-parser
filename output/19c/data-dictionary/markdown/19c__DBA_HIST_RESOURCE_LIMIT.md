...
Previous Next JavaScript must be enabled to correctly display this content This view contains snapshots of V$RESOURCE_LIMIT . If time is of interest, join this view with DBA_HIST_SNAPSHOT.END_INTERVAL_TIME .