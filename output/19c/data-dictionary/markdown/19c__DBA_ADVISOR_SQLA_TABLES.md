...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_ADVISOR_SQLA_TABLES displays cross references between the workload statements and the tables referenced in the statement for the current user. This view does not display the OWNER column. See Also: " USER_ADVISOR_SQLA_TABLES " See Also: " USER_ADVISOR_SQLA_TABLES "