...
Previous Next JavaScript must be enabled to correctly display this content Set the LOG_CHECKPOINT_TIMEOUT initialization parameter Set the LOG_CHECKPOINT_INTERVAL initialization parameter Set the FAST_START_MTTR_TARGET initialization parameter Set the size of the smallest redo log