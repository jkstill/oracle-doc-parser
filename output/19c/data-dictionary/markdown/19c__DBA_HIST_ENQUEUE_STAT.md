...
Previous Next JavaScript must be enabled to correctly display this content This view contains snapshots of V$ENQUEUE_STATISTICS . See Also: " V$ENQUEUE_STATISTICS " See Also: " V$ENQUEUE_STATISTICS "