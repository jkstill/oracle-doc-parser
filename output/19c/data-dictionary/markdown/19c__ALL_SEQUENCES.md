...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_SEQUENCES describes all sequences in the database. USER_SEQUENCES describes all sequences owned by the current user. This view does not display the SEQUENCE_OWNER column. See Also: " DBA_SEQUENCES " " USER_SEQUENCES " See Also: " DBA_SEQUENCES " " USER_SEQUENCES "