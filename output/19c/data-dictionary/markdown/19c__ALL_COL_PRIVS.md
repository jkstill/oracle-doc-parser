...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_COL_PRIVS describes all column object grants in the database. USER_COL_PRIVS describes the column object grants for which the current user is the object owner, grantor, or grantee. See Also: " DBA_COL_PRIVS " " USER_COL_PRIVS " See Also: " DBA_COL_PRIVS " " USER_COL_PRIVS "