...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_MINING_MODEL_PARTITIONS describes all the model partitions accessible to the system. USER_MINING_MODEL_PARTITIONS describes the user's own model partitions. This view does not display the OWNER column.