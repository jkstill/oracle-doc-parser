...
category: objects
tags: [all]
source_file: ALL_OBJECTS_AE.html
---
...
| DATA_OBJECT_ID | NUMBER | Dictionary object number of the segment which contains the object |
...
Previous Next JavaScript must be enabled to correctly display this content DBA_OBJECTS_AE describes all objects (across all editions) in the database. USER_OBJECTS_AE describes the objects (across all editions) owned by the current user. This view does not display the OWNER column. See Also: " DBA_OBJECTS_AE " " USER_OBJECTS_AE " See Also: " DBA_OBJECTS_AE " " USER_OBJECTS_AE "