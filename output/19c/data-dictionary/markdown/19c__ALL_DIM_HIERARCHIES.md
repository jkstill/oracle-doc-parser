...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_DIM_HIERARCHIES describes all such hierarchies in the database. USER_DIM_HIERARCHIES describes all such hierarchies owned by the current user. See Also: " DBA_DIM_HIERARCHIES " " USER_DIM_HIERARCHIES " See Also: " DBA_DIM_HIERARCHIES " " USER_DIM_HIERARCHIES "