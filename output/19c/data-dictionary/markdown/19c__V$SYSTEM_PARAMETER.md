...
Previous Next JavaScript must be enabled to correctly display this content See Also: " V$PARAMETER " for information about initialization parameters that are currently in effect for a session See Also: " V$PARAMETER " for information about initialization parameters that are currently in effect for a session