...
Previous Next JavaScript must be enabled to correctly display this content This view is for logical standby databases only. See Also: Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_LOGSTDBY.SKIP_ERROR procedure Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_LOGSTDBY.SKIP procedure See Also: Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_LOGSTDBY.SKIP_ERROR procedure Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_LOGSTDBY.SKIP procedure