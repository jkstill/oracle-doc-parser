...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_DIMENSIONS describes all dimensions in the database. USER_DIMENSIONS describes the dimensions in the current user's schema. See Also: " DBA_DIMENSIONS " " USER_DIMENSIONS " See Also: " DBA_DIMENSIONS " " USER_DIMENSIONS "