...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_INDEXTYPE_ARRAYTYPES displays information about the array types specified by all indextypes in the database. USER_INDEXTYPE_ARRAYTYPES displays information about the array types specified by the indextypes owned by the current user. See Also: " DBA_INDEXTYPE_ARRAYTYPES " " USER_INDEXTYPE_ARRAYTYPES " See Also: " DBA_INDEXTYPE_ARRAYTYPES " " USER_INDEXTYPE_ARRAYTYPES "