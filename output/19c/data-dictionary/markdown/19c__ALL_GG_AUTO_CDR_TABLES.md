...
Previous Next JavaScript must be enabled to correctly display this content Related View DBA_GG_AUTO_CDR_TABLES provides details about all the tables configured for Oracle GoldenGate automatic conflict detection and resolution (CDR). See Also: " DBA_GG_AUTO_CDR_TABLES " See Also: " DBA_GG_AUTO_CDR_TABLES "