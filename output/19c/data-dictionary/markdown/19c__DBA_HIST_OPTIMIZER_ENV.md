...
Previous Next JavaScript must be enabled to correctly display this content This view is used with the DBA_HIST_SQLSTAT view. See Also: " DBA_HIST_SQLSTAT " See Also: " DBA_HIST_SQLSTAT "