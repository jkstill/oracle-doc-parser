...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_SCHEDULER_RUNNING_JOBS displays information about all running Scheduler jobs in the database. USER_SCHEDULER_RUNNING_JOBS displays information about the running Scheduler jobs owned by the current user. This view does not display the OWNER column. See Also: " DBA_SCHEDULER_RUNNING_JOBS " " USER_SCHEDULER_RUNNING_JOBS " See Also: " DBA_SCHEDULER_RUNNING_JOBS " " USER_SCHEDULER_RUNNING_JOBS "