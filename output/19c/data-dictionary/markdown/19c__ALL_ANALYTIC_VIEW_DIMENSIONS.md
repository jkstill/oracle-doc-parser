---
id: 19c__ALL_ANALYTIC_VIEW_DIMENSIONS
name: ALL_ANALYTIC_VIEW_DIMENSIONS
object_type: data_dictionary_view
oracle_version: 19c
doc_type: database_reference
category: objects
tags: [all]
source_file: ALL_ANALYTIC_VIEW_DIMENSIONS.html
---
...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_ANALYTIC_VIEW_DIMENSIONS describes the attribute dimensions in all analytic views in the database. USER_ANALYTIC_VIEW_DIMENSIONS describes the attribute dimensions in the analytic views owned by the current user. This view does not display the OWNER column. See Also: " DBA_ANALYTIC_VIEW_DIMENSIONS " " USER_ANALYTIC_VIEW_DIMENSIONS " See Also: " DBA_ANALYTIC_VIEW_DIMENSIONS " " USER_ANALYTIC_VIEW_DIMENSIONS "