---
id: 19c__DBA_HIST_LATCH_CHILDREN
name: DBA_HIST_LATCH_CHILDREN
object_type: data_dictionary_view
oracle_version: 19c
doc_type: database_reference
category: general
tags: [dba]
source_file: DBA_HIST_LATCH_CHILDREN.html
---
...
Previous Next JavaScript must be enabled to correctly display this content This view includes all columns of DBA_HIST_LATCH plus the CHILD# column. Note that child latches have the same parent if their LATCH# columns match each other. This view contains snapshots of V$LATCH_CHILDREN . See Also: " DBA_HIST_LATCH " " V$LATCH " See Also: " DBA_HIST_LATCH " " V$LATCH "