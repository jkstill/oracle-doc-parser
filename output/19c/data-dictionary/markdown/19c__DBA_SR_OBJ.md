...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_SR_OBJ provides information on the objects registered for synchronous refresh for current groups for the current user. Its columns are the same as those in DBA_SR_OBJ . See Also: " USER_SR_OBJ " See Also: " USER_SR_OBJ "