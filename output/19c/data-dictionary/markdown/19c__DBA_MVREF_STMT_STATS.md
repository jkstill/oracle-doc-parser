...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_MVREF_STMT_STATS shows information associated with each refresh statement of a materialized view accessible to the current user in a refresh run. See Also: " USER_MVREF_STMT_STATS " See Also: " USER_MVREF_STMT_STATS "