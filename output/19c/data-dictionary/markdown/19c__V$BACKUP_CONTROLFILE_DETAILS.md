...
Previous Next JavaScript must be enabled to correctly display this content It will include all the control files backed up in the backup set, image copies, and proxy copies.