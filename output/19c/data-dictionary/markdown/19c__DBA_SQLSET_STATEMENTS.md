...
tags: [dba]
source_file: DBA_SQLSET_STATEMENTS.html
---
...
| PARSING_SCHEMA_ID | NUMBER | ID of the schema in which the statement was parsed |
...
| STAT_PERIOD | NUMBER | Period of time (in seconds) during which the statistics of the SQL statement were collected |
...
Previous Next JavaScript must be enabled to correctly display this content See Also: " ALL_SQLSET_STATEMENTS " Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_APPLICATION_INFO.SET_MODULE procedure Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_APPLICATION_INFO.SET_ACTION procedure See Also: " ALL_SQLSET_STATEMENTS " Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_APPLICATION_INFO.SET_MODULE procedure Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_APPLICATION_INFO.SET_ACTION procedure