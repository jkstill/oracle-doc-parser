...
Previous Next JavaScript must be enabled to correctly display this content This view contains snapshots of information from V$DISPATCHER and V$QUEUE . See Also: " V$DISPATCHER " " V$QUEUE " See Also: " V$DISPATCHER " " V$QUEUE "