...
Previous Next JavaScript must be enabled to correctly display this content Note that corruptions are not tolerated in the control file and archived redo log backups.