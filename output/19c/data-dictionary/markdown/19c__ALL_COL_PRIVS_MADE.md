...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_COL_PRIVS_MADE describes the column object grants for which the current user is the object owner. This view does not display the OWNER column. See Also: " USER_COL_PRIVS_MADE " See Also: " USER_COL_PRIVS_MADE "