...
Previous Next JavaScript must be enabled to correctly display this content The data displayed pertains to the container in which the view is queried. This view is for logical standby databases only.