...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_DBFS_HS_FIXED_PROPERTIES shows non-modifiable properties of all DBFS hierarchical stores owned by current user. This view does not display the STORE_OWNER column. See Also: " USER_DBFS_HS_FIXED_PROPERTIES " See Also: " USER_DBFS_HS_FIXED_PROPERTIES "