...
Previous Next JavaScript must be enabled to correctly display this content Related View DBA_STREAMS_NEWLY_SUPPORTED displays information about all tables in the database that are newly supported by capture processes. See Also: " DBA_STREAMS_NEWLY_SUPPORTED " See Also: " DBA_STREAMS_NEWLY_SUPPORTED "