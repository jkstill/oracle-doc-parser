...
Previous Next JavaScript must be enabled to correctly display this content Related View USER_SEGMENTS describes the storage allocated for the segments owned by the current user's objects. This view does not display the OWNER , HEADER_FILE , HEADER_BLOCK , or RELATIVE_FNO columns. See Also: " USER_SEGMENTS " See Also: " USER_SEGMENTS "