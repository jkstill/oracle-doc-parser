...
Previous Next JavaScript must be enabled to correctly display this content In addition to the set of commands in the COMMAND column of V$SESSION , the following additional commands are defined: RUN ADVISOR CHECK EXECUTION PLAN ALTER PARAMETER ENABLE TRACE