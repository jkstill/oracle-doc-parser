...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_XML_VIEWS describes all XML views the database. USER_XML_VIEWS describes the XML views owned by the current user. This view does not display the OWNER column. See Also: " DBA_XML_VIEWS " " USER_XML_VIEWS " See Also: " DBA_XML_VIEWS " " USER_XML_VIEWS "