...
Previous Next JavaScript must be enabled to correctly display this content This view is for logical standby databases only. Note: The SCN values in this view correlate to the SCN values shown in the DBA_LOGSTDBY_PROGRESS view. Note: In a CDB, this view shows data only when queried in the root. Note: The SCN values in this view correlate to the SCN values shown in the DBA_LOGSTDBY_PROGRESS view. Note: In a CDB, this view shows data only when queried in the root.