...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_HIVE_DATABASES describes all the Hive schemas in a Hadoop cluster. USER_HIVE_DATABASES describes all the Hive schemas owned by the current user in a Hadoop cluster. See Also: " DBA_HIVE_DATABASES " " USER_HIVE_DATABASES " See Also: " DBA_HIVE_DATABASES " " USER_HIVE_DATABASES "