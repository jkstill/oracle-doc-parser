...
Previous Next JavaScript must be enabled to correctly display this content Related Views DBA_TYPES describes all object types in the database. USER_TYPES describes the object types owned by the current user. This view does not display the OWNER column. See Also: " DBA_TYPES " " USER_TYPES " See Also: " DBA_TYPES " " USER_TYPES "