...
Related Views DBA_SQL_TRANSLATIONS describes all SQL translations in the database. USER_SQL_TRANSLATIONS describes all SQL translations owned by the user. This view does not display the OWNER column. See Also: " DBA_SQL_TRANSLATIONS " " USER_SQL_TRANSLATIONS " See Also: " DBA_SQL_TRANSLATIONS " " USER_SQL_TRANSLATIONS "