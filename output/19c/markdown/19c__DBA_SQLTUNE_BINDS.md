...
Related View USER_SQLTUNE_BINDS displays the bind values associated with the tuned SQL statements owned by the current user. See Also: " USER_SQLTUNE_BINDS " See Also: " USER_SQLTUNE_BINDS "