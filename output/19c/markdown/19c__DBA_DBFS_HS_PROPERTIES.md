...
Related View USER_DBFS_HS_PROPERTIES shows modifiable properties of all DBFS hierarchical stores owned by current user. This view does not display the STOREOWNER column. See Also: " USER_DBFS_HS_PROPERTIES " See Also: " USER_DBFS_HS_PROPERTIES "