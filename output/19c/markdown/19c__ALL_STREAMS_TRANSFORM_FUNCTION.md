...
Related View DBA_STREAMS_TRANSFORM_FUNCTION displays information about all rule-based transformation functions in the database. See Also: " DBA_STREAMS_TRANSFORM_FUNCTION " See Also: " DBA_STREAMS_TRANSFORM_FUNCTION "