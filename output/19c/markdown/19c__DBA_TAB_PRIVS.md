...
Related View USER_TAB_PRIVS describes the object grants for which the current user is the object owner, grantor, or grantee. See Also: " USER_TAB_PRIVS " See Also: " USER_TAB_PRIVS "