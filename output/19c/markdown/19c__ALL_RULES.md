...
Related Views DBA_RULES describes all rules in the database. USER_RULES describes the rules owned by the current user. This view does not display the RULE_OWNER column. See Also: " DBA_RULES " " USER_RULES " See Also: " DBA_RULES " " USER_RULES "