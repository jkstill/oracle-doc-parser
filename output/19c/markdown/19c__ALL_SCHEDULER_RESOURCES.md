...
Related Views DBA_SCHEDULER_RESOURCES displays all scheduler resource objects in the database. USER_SCHEDULER_RESOURCES displays all scheduler resource objects in the database from the schema of the current user. This view does not display the OWNER column. See Also: " DBA_SCHEDULER_RESOURCES " " USER_SCHEDULER_RESOURCES " See Also: " DBA_SCHEDULER_RESOURCES " " USER_SCHEDULER_RESOURCES "