...
Workload references are necessary to allow the SQL Access Advisor to find required workload data. Related View USER_ADVISOR_SQLA_WK_MAP displays the workload references for the tasks owned by the current user. This view does not display the OWNER column. See Also: " USER_ADVISOR_SQLA_WK_MAP " See Also: " USER_ADVISOR_SQLA_WK_MAP "