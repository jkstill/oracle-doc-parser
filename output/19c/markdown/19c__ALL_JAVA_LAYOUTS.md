...
Related Views DBA_JAVA_LAYOUTS displays class layout information about all stored Java classes in the database. USER_JAVA_LAYOUTS displays class layout information about the stored Java classes owned by the current user. This view does not display the OWNER column. See Also: " DBA_JAVA_LAYOUTS " " USER_JAVA_LAYOUTS " See Also: " DBA_JAVA_LAYOUTS " " USER_JAVA_LAYOUTS "