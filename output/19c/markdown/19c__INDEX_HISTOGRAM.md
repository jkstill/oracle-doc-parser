...
Note: The ANALYZE INDEX ... VALIDATE STRUCTURE OFFLINE statement must be used to collect statistics. Note: The ANALYZE INDEX ... VALIDATE STRUCTURE OFFLINE statement must be used to collect statistics.