...
Related View DBA_SCHEDULER_WINDOW_LOG displays log information for all Scheduler windows in the database. See Also: " DBA_SCHEDULER_WINDOW_LOG " See Also: " DBA_SCHEDULER_WINDOW_LOG "