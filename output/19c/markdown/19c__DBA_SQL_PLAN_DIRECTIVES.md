...
See Also: " DBA_SQL_PLAN_DIR_OBJECTS " Oracle Database SQL Tuning Guide for more information about SQL plan directives See Also: " DBA_SQL_PLAN_DIR_OBJECTS " Oracle Database SQL Tuning Guide for more information about SQL plan directives