...
Related View USER_SQLTUNE_STATISTICS displays statistics associated with the SQL statements owned by the current user. See Also: " USER_SQLTUNE_STATISTICS " See Also: " USER_SQLTUNE_STATISTICS "