...
Related View USER_ADDM_TASK_DIRECTIVES displays information about ADDM task directives owned by the current user. See Also: " USER_ADDM_TASK_DIRECTIVES " See Also: " USER_ADDM_TASK_DIRECTIVES "