...
Related Views DBA_DIM_LEVEL_KEY describes all columns of dimension levels in the database. USER_DIM_LEVEL_KEY describes all columns of dimension levels owned by the current user. See Also: " DBA_DIM_LEVEL_KEY " " USER_DIM_LEVEL_KEY " See Also: " DBA_DIM_LEVEL_KEY " " USER_DIM_LEVEL_KEY "