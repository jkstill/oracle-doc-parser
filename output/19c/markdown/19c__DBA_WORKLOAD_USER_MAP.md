...
The mappings are stored in a table made public through this view. To remove old mappings, execute this statement: SQL> delete * from DBA_WORKLOAD_USER_MAP; See Also: " DBA_WORKLOAD_REPLAYS " See Also: " DBA_WORKLOAD_REPLAYS "