...
Related Views DBA_SCHEDULER_JOB_ARGS displays information about the arguments of all Scheduler jobs in the database. USER_SCHEDULER_JOB_ARGS displays information about the arguments of the Scheduler jobs owned by the current user. This view does not display the OWNER column. See Also: " DBA_SCHEDULER_JOB_ARGS " " USER_SCHEDULER_JOB_ARGS " See Also: " DBA_SCHEDULER_JOB_ARGS " " USER_SCHEDULER_JOB_ARGS "