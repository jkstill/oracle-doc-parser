...
Related Views DBA_LOBS describes all LOBs in the database. USER_LOBS describes the LOBs owned by the current user. This view does not display the OWNER column. See Also: " DBA_LOBS " " USER_LOBS " See Also: " DBA_LOBS " " USER_LOBS "