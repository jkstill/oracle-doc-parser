...
Related View USER_OUTLINE_HINTS describes the set of hints stored in the outlines owned by the current user. This view does not display the OWNER column. See Also: " USER_OUTLINE_HINTS " See Also: " USER_OUTLINE_HINTS "