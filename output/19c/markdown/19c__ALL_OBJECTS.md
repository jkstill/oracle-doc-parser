...
Related Views DBA_OBJECTS describes all objects in the database. USER_OBJECTS describes all objects owned by the current user. This view does not display the OWNER column. See Also: " DBA_OBJECTS " " USER_OBJECTS " See Also: " DBA_OBJECTS " " USER_OBJECTS "