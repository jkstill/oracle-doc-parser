...
Related Views DBA_SQLSET_BINDS displays the bind values associated with all SQL tuning sets in the database. USER_SQLSET_BINDS displays the bind values associated with the SQL tuning sets owned by the current user. This view does not display the SQLSET_OWNER column. See Also: " DBA_SQLSET_BINDS " " USER_SQLSET_BINDS " See Also: " DBA_SQLSET_BINDS " " USER_SQLSET_BINDS "