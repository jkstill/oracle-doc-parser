...
The view contains one row for each task. Related View USER_ADVISOR_LOG displays information about the current state of the tasks owned by the current user. This view does not display the OWNER column. See Also: " USER_ADVISOR_LOG " See Also: " USER_ADVISOR_LOG "