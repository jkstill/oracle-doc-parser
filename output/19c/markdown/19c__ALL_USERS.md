...
This view does not describe the users (see the related views). Related Views DBA_USERS describes all users of the database, and contains more columns than ALL_USERS . USER_USERS describes the current user, and contains more columns than ALL_USERS . See Also: " DBA_USERS " " USER_USERS " Using Oracle Sharding for more information about sharded database management See Also: " DBA_USERS " " USER_USERS " Using Oracle Sharding for more information about sharded database management