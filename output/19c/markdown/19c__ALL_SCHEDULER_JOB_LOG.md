...
Related Views DBA_SCHEDULER_JOB_LOG displays log information for all Scheduler jobs in the database. USER_SCHEDULER_JOB_LOG displays log information for the Scheduler jobs owned by the current user. See Also: " DBA_SCHEDULER_JOB_LOG " " USER_SCHEDULER_JOB_LOG " See Also: " DBA_SCHEDULER_JOB_LOG " " USER_SCHEDULER_JOB_LOG "