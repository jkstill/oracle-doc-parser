...
Related View DBA_XSTREAM_TRANSFORMATIONS displays information about all XStream transformations available on a system, in order of execution. See Also: " DBA_XSTREAM_TRANSFORMATIONS " See Also: " DBA_XSTREAM_TRANSFORMATIONS "