...
Related Views DBA_OPARGUMENTS describes arguments of all operator bindings in the database. USER_OPARGUMENTS describes arguments of all operator bindings owned by the current user. See Also: " DBA_OPARGUMENTS " " USER_OPARGUMENTS " See Also: " DBA_OPARGUMENTS " " USER_OPARGUMENTS "