...
Related View USER_PARALLEL_EXECUTE_CHUNKS displays the chunks for tasks created by the current user. This view does not display the TASK_OWNER column. See Also: " USER_PARALLEL_EXECUTE_CHUNKS " See Also: " USER_PARALLEL_EXECUTE_CHUNKS "