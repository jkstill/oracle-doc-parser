...
Related View USER_COL_PRIVS_RECD describes the column object grants for which the current user is the grantee. This view does not display the GRANTEE column. See Also: " USER_COL_PRIVS_RECD " See Also: " USER_COL_PRIVS_RECD "