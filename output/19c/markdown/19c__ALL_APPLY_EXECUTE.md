...
Related View DBA_APPLY_EXECUTE displays information about the apply execute actions for all rules in the database. See Also: " DBA_APPLY_EXECUTE " See Also: " DBA_APPLY_EXECUTE "