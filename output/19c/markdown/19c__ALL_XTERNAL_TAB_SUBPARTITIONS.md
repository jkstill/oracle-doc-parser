...
Related Views DBA_XTERNAL_TAB_SUBPARTITIONS describes subpartition-level information for partitioned external tables in the database. USER_XTERNAL_TAB_SUBPARTITIONS describes subpartition-level information for partitioned external tables owned by the current user. This view does not display the TABLE_OWNER column. See Also: " DBA_XTERNAL_TAB_SUBPARTITIONS " " USER_XTERNAL_TAB_SUBPARTITIONS " See Also: " DBA_XTERNAL_TAB_SUBPARTITIONS " " USER_XTERNAL_TAB_SUBPARTITIONS "