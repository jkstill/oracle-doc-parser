...
Related Views DBA_INTERNAL_TRIGGERS describes internal triggers on all tables in the database. USER_INTERNAL_TRIGGERS describes all internal triggers on tables owned by the current user. This view does not display the OWNER_NAME column. See Also: " DBA_INTERNAL_TRIGGERS " " USER_INTERNAL_TRIGGERS " See Also: " DBA_INTERNAL_TRIGGERS " " USER_INTERNAL_TRIGGERS "