...
Related Views DBA_PART_LOBS displays table-level information about all partitioned LOBs in the database. USER_PART_LOBS displays table-level information about the partitioned LOBs owned by the current user. This view does not display the TABLE_OWNER column. See Also: " DBA_PART_LOBS " " USER_PART_LOBS " See Also: " DBA_PART_LOBS " " USER_PART_LOBS "