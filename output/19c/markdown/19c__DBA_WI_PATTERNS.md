...
These templates that comprise the given pattern are described in the related view DBA_WI_PATTERN_ITEMS . See Also: " DBA_WI_PATTERN_ITEMS " See Also: " DBA_WI_PATTERN_ITEMS "