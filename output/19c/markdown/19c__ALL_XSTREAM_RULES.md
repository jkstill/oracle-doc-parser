...
Related View DBA_XSTREAM_RULES displays information about all XStream server rules in the database. See Also: " DBA_XSTREAM_RULES " See Also: " DBA_XSTREAM_RULES "