...
This view is for logical standby databases only. Note: In a CDB, this view shows data when queried in the root. Note: In a CDB, this view shows data when queried in the root.