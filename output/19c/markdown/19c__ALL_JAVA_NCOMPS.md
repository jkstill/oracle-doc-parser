...
Related Views DBA_JAVA_NCOMPS displays ncomp -related information about all Java classes in the database. USER_JAVA_NCOMPS displays ncomp -related information about the Java classes owned by the current user. This view does not display the OWNER column. See Also: " DBA_JAVA_NCOMPS " " USER_JAVA_NCOMPS " See Also: " DBA_JAVA_NCOMPS " " USER_JAVA_NCOMPS "