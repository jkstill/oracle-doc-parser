...
See Also: " V$GES_BLOCKING_ENQUEUE " for a description of all such locks that are currently blocking or being blocked See Also: " V$GES_BLOCKING_ENQUEUE " for a description of all such locks that are currently blocking or being blocked