...
Related View USER_PARALLEL_EXECUTE_TASKS displays the tasks created by the current user. This view does not display the TASK_OWNER column. See Also: " USER_PARALLEL_EXECUTE_TASKS " Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_PARALLEL_EXECUTE.RUN_TASK procedure See Also: " USER_PARALLEL_EXECUTE_TASKS " Oracle Database PL/SQL Packages and Types Reference for more information about the DBMS_PARALLEL_EXECUTE.RUN_TASK procedure