...
Related View DBA_SCHEDULER_WINDOW_DETAILS displays log details for all Scheduler windows in the database. See Also: " DBA_SCHEDULER_WINDOW_DETAILS " See Also: " DBA_SCHEDULER_WINDOW_DETAILS "