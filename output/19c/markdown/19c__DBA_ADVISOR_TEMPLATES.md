...
Related View USER_ADVISOR_TEMPLATES displays information about the templates owned by the current user. This view does not display the OWNER column. See Also: " USER_ADVISOR_TEMPLATES " See Also: " USER_ADVISOR_TEMPLATES "