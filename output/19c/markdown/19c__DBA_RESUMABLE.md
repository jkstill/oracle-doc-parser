...
Related View USER_RESUMABLE displays the resumable statements executed by the current user. This view does not display the USER_ID column. See Also: " USER_RESUMABLE " See Also: " USER_RESUMABLE "