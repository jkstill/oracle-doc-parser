...
Related View USER_ADVISOR_SQLPLANS displays the different SQL execution plans owned by the current user generated as part of an advisor analysis. See Also: " USER_ADVISOR_SQLPLANS " See Also: " USER_ADVISOR_SQLPLANS "