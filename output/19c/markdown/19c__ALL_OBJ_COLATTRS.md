...
Related Views DBA_OBJ_COLATTRS describes object columns and attributes contained in all tables in the database. USER_OBJ_COLATTRS describes object columns and attributes contained in the tables owned by the current user. This view does not display the OWNER column. See Also: " DBA_OBJ_COLATTRS " " USER_OBJ_COLATTRS " See Also: " DBA_OBJ_COLATTRS " " USER_OBJ_COLATTRS "