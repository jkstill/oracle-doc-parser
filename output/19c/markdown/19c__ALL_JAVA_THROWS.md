...
Related Views DBA_JAVA_THROWS displays information about exceptions thrown from methods of all Java classes in the database. USER_JAVA_THROWS displays information about exceptions thrown from methods of the Java classes owned by the current user. This view does not display the OWNER column. See Also: " DBA_JAVA_THROWS " " USER_JAVA_THROWS " See Also: " DBA_JAVA_THROWS " " USER_JAVA_THROWS "