...
Related Views DBA_SCHEDULER_JOBS displays information about all Scheduler jobs in the database. USER_SCHEDULER_JOBS displays information about the Scheduler jobs owned by the current user. This view does not display the OWNER column. See Also: " DBA_SCHEDULER_JOBS " " USER_SCHEDULER_JOBS " See Also: " DBA_SCHEDULER_JOBS " " USER_SCHEDULER_JOBS "