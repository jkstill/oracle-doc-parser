...
Related View USER_EDITIONED_TYPES lists the types that are editioned by default for the current user. This view does not display the SCHEMA column. See Also: " USER_EDITIONED_TYPES " See Also: " USER_EDITIONED_TYPES "