...
Related View USER_SQLTUNE_PLANS displays information about the execution plans generated for the SQL statements owned by the current user during a SQL tuning session. See Also: " USER_SQLTUNE_PLANS " See Also: " USER_SQLTUNE_PLANS "