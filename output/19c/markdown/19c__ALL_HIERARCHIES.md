...
Related Views DBA_HIERARCHIES describes all hierarchies in the database. USER_HIERARCHIES describes the hierarchies owned by the current user. This view does not display the OWNER column. See Also: " DBA_HIERARCHIES " " USER_HIERARCHIES " See Also: " DBA_HIERARCHIES " " USER_HIERARCHIES "