...
Related Views DBA_ERROR_TRANSLATIONS describes all error translations in the database. USER_ERROR_TRANSLATIONS describes all error translations owned by the user. This view does not display the OWNER column. See Also: " DBA_ERROR_TRANSLATIONS " " USER_ERROR_TRANSLATIONS " See Also: " DBA_ERROR_TRANSLATIONS " " USER_ERROR_TRANSLATIONS "