...
This view includes all columns of V$LATCH plus the CHILD# column. Note that child latches have the same parent if their LATCH# columns match each other. See Also: " V$LATCH " See Also: " V$LATCH "