...
Related View USER_ADVISOR_SQLSTATS displays execution statistics owned by the current user for the test-execution of different SQL plans during the advisor analysis. See Also: " USER_ADVISOR_SQLSTATS " " Statistics Descriptions " for more information about statistics See Also: " USER_ADVISOR_SQLSTATS " " Statistics Descriptions " for more information about statistics