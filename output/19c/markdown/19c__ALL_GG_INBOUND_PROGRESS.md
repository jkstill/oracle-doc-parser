...
Related View DBA_GG_INBOUND_PROGRESS displays information about the progress made by all GoldenGate inbound servers in the database. See Also: " DBA_GG_INBOUND_PROGRESS " See Also: " DBA_GG_INBOUND_PROGRESS "