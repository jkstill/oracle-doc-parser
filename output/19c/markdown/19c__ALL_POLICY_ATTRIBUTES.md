...
Related Views DBA_POLICY_ATTRIBUTES lists the attribute associations {Namespaces, Attributes} of all context-sensitive and shared context-sensitive Oracle Virtual Private Database (VPD) policies in the database. USER_POLICY_ATTRIBUTES lists the attribute associations {Namespaces, Attributes} of all context-sensitive and shared-context sensitive Oracle Virtual Private Database (VPD) policies for synonyms, tables, or views owned by the user. See Also: " DBA_POLICY_ATTRIBUTES " " USER_POLICY_ATTRIBUTES " See Also: " DBA_POLICY_ATTRIBUTES " " USER_POLICY_ATTRIBUTES "