...
Related View DBA_SYNC_CAPTURE_TABLES displays information about all tables in the database that are captured by synchronous captures. See Also: " DBA_SYNC_CAPTURE_TABLES " See Also: " DBA_SYNC_CAPTURE_TABLES "