...
Related Views DBA_MVIEW_LOGS describes all materialized view logs in the database. USER_MVIEW_LOGS describes all materialized view logs owned by the current user. See Also: " DBA_MVIEW_LOGS " " USER_MVIEW_LOGS " See Also: " DBA_MVIEW_LOGS " " USER_MVIEW_LOGS "