...
This view provides access to analyzed role records in SYS tables. You must have the CAPTURE_ADMIN role to access this view. See Also: " DBA_CHECKED_ROLES_PATH " See Also: " DBA_CHECKED_ROLES_PATH "