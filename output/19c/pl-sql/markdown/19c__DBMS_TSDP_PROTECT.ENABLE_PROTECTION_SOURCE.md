---
id: 19c__DBMS_TSDP_PROTECT.ENABLE_PROTECTION_SOURCE
name: DBMS_TSDP_PROTECT.ENABLE_PROTECTION_SOURCE
...
Syntax DBMS_TSDP_PROTECT.ENABLE_PROTECTION_SOURCE ( discovery_sourcename IN VARCHAR2); Parameters Table 182-11 ENABLE_PROTECTION_SOURCE Procedure Parameters Parameter Description discovery_sourcename Name of the discovery source. This could be the Application Data Model (ADM) name or the database user. Examples Enable protection for all columns corresponding to ADM_Demo : DBMS_TSDP_PROTECT.ENABLE_PROTECTION_SOURCE ('ADM_Demo');