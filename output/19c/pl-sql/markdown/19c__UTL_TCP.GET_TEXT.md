---
id: 19c__UTL_TCP.GET_TEXT
name: UTL_TCP.GET_TEXT
...
| len | PLS_INTEGER | IN | Number of bytes (or characters for VARCHAR2 ) of data to receive. Default is 1. |
