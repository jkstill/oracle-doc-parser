---
id: 19c__DBMS_WORKLOAD_REPOSITORY.ASH_GLOBAL_REPORT_TEXT
name: DBMS_WORKLOAD_REPOSITORY.ASH_GLOBAL_REPORT_TEXT
...
|-----------|------|------|-------------|
| l_dbid | VARCHAR2(1023) | IN | Database identifier |
| l_inst_num | NUMBER | IN | List of instances (such as '1,2,3' ), or NULL to report on all instances in the database |
