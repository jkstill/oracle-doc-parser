---
id: 19c__DBMS_ADDM.DELETE_SEGMENT_DIRECTIVE
name: DBMS_ADDM.DELETE_SEGMENT_DIRECTIVE
...
Syntax DBMS_ADDM.DELETE_SEGMENT_DIRECTIVE ( task_name IN VARCHAR2, dir_name IN VARCHAR2); Parameters Table 14-12 DELETE_SEGMENT_DIRECTIVE Procedure Parameters Parameter Description task_name Name of the task this directive applies to. If the value is NULL , it is a system directive. dir_name Name of the directive. All directives must be given unique names.