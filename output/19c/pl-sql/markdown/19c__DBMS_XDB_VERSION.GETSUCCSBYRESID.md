---
id: 19c__DBMS_XDB_VERSION.GETSUCCSBYRESID
name: DBMS_XDB_VERSION.GETSUCCSBYRESID
...
Syntax DBMS_XDB_VERSION.GETSUCCSBYRESID( resid resid_type) RETURN resid_list_type; Parameters Table 199-11 GETSUCCSBYRESID Function Parameters Parameter Description resid The resource id. Usage Notes Getting successors by RESID is more efficient than by pathname . Exceptions An exception is raised if the pathname is illegal.